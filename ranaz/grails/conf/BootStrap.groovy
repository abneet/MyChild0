...
"""
		...
		school.schoole_name = "Sandeepaani"
		school.address = "bangalore"
		school.landmark = " bekary"
		...
		school.save(flush:true);
		 ...
		 Conversation testconv = new Conversation(fromId:ravi.username , toId: rani.username ,fromName:ravi.name, toName:rani.name, title: "Test Conversation between ravi and raani" , inTrash: false,isRead: false,toDate: new Date(),fromDate: new Date())
		 testconv.addToMessages(new Message(fromId: "ravi" , toId: "rani" ,fromName:ravi.name, toName:rani.name, messageText: "Haai raani" , messageTime:new Date() ))
		 .addToMessages(new Message(fromId: "rani" , toId: "ravi" ,fromName:rani.name, toName:ravi.name, messageText: "Haai raviii" , messageTime: new Date()))
		 .save()
		 ravi.addToConversations(testconv)
		 rani.addToConversations(testconv)
		 ravi.save()
		 rani.save()
		 testconv = new Conversation(fromId:ravi.username , toId: rani.username ,fromName:ravi.name, toName:rani.name, title: "Test Conversation between ravi and raani" , inTrash: false,isRead: false,toDate: new Date(),fromDate: new Date())
		 testconv.addToMessages(new Message(fromId: "ravi" , toId: "rani" ,fromName:ravi.name, toName:rani.name, messageText: "Again Haai raani" , messageTime:new Date() ))
		 .addToMessages(new Message(fromId: "rani" , toId: "ravi" ,fromName:rani.name, toName:ravi.name, messageText: "Again Haai raviii" , messageTime: new Date()))
		 .save()
		 ravi.addToConversations(testconv)
		 rani.addToConversations(testconv)
		 ravi.save()
		 rani.save()
		 testconv = new Conversation(fromId: mahadev.username , toId: malini.username ,fromName:mahadev.name, toName:malini.name, title: "Message from Mahadev to Malini" , inTrash: false , isRead: false , toDate: new Date() , fromDate: new Date() )
		 .addToMessages(new Message(fromId: "Mahadev" , toId: "Malini" ,fromName:mahadev.name, toName:malini.name, messageTime: new Date() , messageText: "Haai malini"))
		 .addToMessages(new Message(fromId: "Malini" , toId: "Mahadev" ,fromName:malini.name, toName:mahadev.name, messageText: "Hello mahadev" , messageTime: new Date()))
		 .save()
		 malini.addToConversations(testconv).save()
		 mahadev.addToConversations(testconv).save()
		 testconv = new Conversation(fromId: manish.username , toId: mathew.username ,fromName:manish.name, toName:mathew.name, title: "Message from Manish" , inTrash: false , isRead: false , toDate: new Date() , fromDate: new Date())
		 .addToMessages(new Message(fromId: "Manish" , toId: "Mathew" ,fromName:manish.name, toName:mathew.name, messageText: "Hai this is Manush" , messageTime: new Date()))
		 .addToMessages(new Message(fromId: "Mathew" , toId: "Manish" ,fromName:mathew.name, toName:manish.name, messageText: "Yes manish , mathew here" , messageTime:  new Date()))
		 .addToMessages(new Message(fromId: "Manish" , toId: "Mathew" ,fromName:manish.name, toName:mathew.name, messageText: "How are you maathew" , messageTime: new Date()))
		 .addToMessages(new Message(fromId: "Mathew" , toId: "Manish" ,fromName:mathew.name, toName:manish.name, messageText: "I am fine manish How are you" , messageTime: new Date()))
		 .addToMessages(new Message(fromId: "Manish" , toId: "Mathew" ,fromName:manish.name, toName:mathew.name, messageText: "I am also fine mathew , Good night" , messageTime: new Date()))
		 .addToMessages(new Message(fromId: "Mathew" , toId: "Manish" ,fromName:mathew.name, toName:manish.name, messageText: "Good night manish...", messageTime: new Date()))
		 .save()
		 mathew.addToConversations(testconv).save()
		 manish.addToConversations(testconv).save()
		 testconv = new Conversation(fromId: shashi.username , toId: mathew.username ,fromName:shashi.name, toName:mathew.name, title: "Message from shashi" , inTrash: false , isRead: false , toDate: new Date() , fromDate: new Date())
		 .addToMessages(new Message(fromId: "shashi" , toId: "Mathew" ,fromName:shashi.name, toName:mathew.name, messageText: "Hai this is shashi" , messageTime: new Date()))
		 .addToMessages(new Message(fromId: "Mathew" , toId: "shashi" ,fromName:mathew.name, toName:shashi.name, messageText: "Yes shashi , mathew here" , messageTime:  new Date()))
		 .addToMessages(new Message(fromId: "shashi" , toId: "Mathew" ,fromName:shashi.name, toName:mathew.name, messageText: "How are you maathew" , messageTime: new Date()))
		 .addToMessages(new Message(fromId: "Mathew" , toId: "shashi" ,fromName:mathew.name, toName:shashi.name, messageText: "I am fine shashi How are you" , messageTime: new Date()))
		 .addToMessages(new Message(fromId: "shashi" , toId: "Mathew" ,fromName:shashi.name, toName:mathew.name, messageText: "I am also fine mathew , Good night" , messageTime: new Date()))
		 .addToMessages(new Message(fromId: "Mathew" , toId: "shashi" ,fromName:mathew.name, toName:shashi.name, messageText: "Good night shashi...", messageTime: new Date()))
		 .save()
		 mathew.addToConversations(testconv).save()
		 shashi.addToConversations(testconv).save()
		 testconv = new Conversation(fromId: malini.username , toId: mathew.username ,fromName:malini.name, toName:mathew.name, title: "Message from Malini" , inTrash: false , isRead: false , toDate: new Date() , fromDate: new Date())
		 .addToMessages(new Message(fromId: "Malini" , toId: "Mathew" ,fromName:malini.name, toName:mathew.name, messageText: "Hai this is Manush" , messageTime: new Date()))
		 .addToMessages(new Message(fromId: "Mathew" , toId: "Malini" ,fromName:mathew.name, toName:malini.name, messageText: "Yes malini , mathew here" , messageTime:  new Date()))
		 .addToMessages(new Message(fromId: "Malini" , toId: "Mathew" ,fromName:malini.name, toName:mathew.name, messageText: "How are you maathew" , messageTime: new Date()))
		 .addToMessages(new Message(fromId: "Mathew" , toId: "Malini" ,fromName:mathew.name, toName:malini.name, messageText: "I am fine malini How are you" , messageTime: new Date()))
		 .addToMessages(new Message(fromId: "Malini" , toId: "Mathew" ,fromName:malini.name, toName:mathew.name, messageText: "I am also fine mathew , Good night" , messageTime: new Date()))
		 .addToMessages(new Message(fromId: "Mathew" , toId: "Malini" ,fromName:mathew.name, toName:malini.name, messageText: "Good night malini...", messageTime: new Date()))
		 .save()
		 mathew.addToConversations(testconv).save()
		 malini.addToConversations(testconv).save()
				...
				student : (grade.students) ?  grade.students?.collect{ Student std ->
					[
						...
						'father' :   [
							...
							'name' : std.getFather()?.name ,
							'email':std.getFather()?.emailId ,
							'mob':std.getFather()?.mobileNumber ,
						],
						'mother' :   [

							'name' : std.getMother()?.name ,
							'email':std.getMother()?.emailId ,
							'mob':std.getMother()?.mobileNumber ,
						],
						'local_guardian' :   [

							'name' : (std.getLocalGuardian())? std.getLocalGuardian()?.name : "No local guardian" ,
							'email' : (std.getLocalGuardian())? std.getLocalGuardian()?.emailId :"No local guardia emailId",
							'mob' : (std.getLocalGuardian())? std.getLocalGuardian()?.emailId :"No local guardia Mobile No",					]
					] } : []]
		...
		JSON.registerObjectMarshaller(Subject) { Subject subject ->
		...
		JSON.registerObjectMarshaller(ExamSyllabus) { ExamSyllabus examSyllabus ->
		...
		JSON.registerObjectMarshaller(Message) { Message m ->
		...
		JSON.registerObjectMarshaller(Exam) { Exam subject ->
		...
		JSON.registerObjectMarshaller( Student ) { Student s ->
			return [
				...
				grade : s.grade?.name.toString() ,
				section : s.grade?.section ,
				father_id:s.father?.id.toString(),
				father: s?.getFather() ,
				mother_id:s.mother?.id.toString(),
				mother: s?.getMother() ,
				local_guardian_id:s.localGuardian?.id.toString(),
		...
		JSON.createNamedConfig('conversationVer1')
		{
			...
			JSON.registerObjectMarshaller(ExamSchedule) { ExamSchedule exSchedule ->
			...
			{ FileManager e ->
				return [
					...
					files: e.files.collect()    { MyChildFile es ->
						[file: [ fileName:  es.fileName,
